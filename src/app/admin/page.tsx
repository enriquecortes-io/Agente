...
export default function AdminPage() {
  ...
  useEffect(() => {
    if (tab === 'Campañas' && campanaTab === 'contactos') fetchEmailLeads();
  }, [campanaTab]);
                ...
                <div style={{background:'#111',border:'1px solid #1e1e1e',borderRadius:'4px',padding:'24px',marginBottom:'16px'}}>
                  ...
                  <input type='file' accept='video/*' id='vid-input' style={{display:'none'}} onChange={async (e) => {
                    ...
                    try {
                      ...
                      await ffmpeg.exec(['-i', `input.${ext}`, '-vf', 'scale=1280:-2', '-c:v', 'libvpx', '-crf', '4', '-b:v', '4M', '-auto-alt-ref', '0', '-c:a', 'libvorbis', 'output.webm']);
